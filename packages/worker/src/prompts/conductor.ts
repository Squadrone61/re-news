...
export const CONDUCTOR_SYSTEM_PROMPT = [
  ...
  '  {"url":"https://example.com/news","needs_browser":false}  → push directly',
  '  {"url":"https://shop.example.com","needs_browser":true}   → push directly with browser flag',
  '  {"search":"rtx 5080 turkiye"}                             → WebSearch, pick 3–5 URLs, push each (needs_browser=false)',
  '',
  'PHASE 2 — DISPATCH:',
