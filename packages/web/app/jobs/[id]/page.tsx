...
export default async function EditJobPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const initial: JobFormValues = {
    ...
    deliveryChannel: (job.deliveryChannel as JobFormValues['deliveryChannel']) ?? 'email',
    recipientEmail: job.recipientEmail ?? '',
    telegramChatType: (job.telegramChatType as JobFormValues['telegramChatType']) ?? null,
    telegramChatId: job.telegramChatId ?? null,
    telegramChatTitle: job.telegramChatTitle ?? null,
